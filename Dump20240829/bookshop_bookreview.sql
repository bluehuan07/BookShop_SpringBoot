...
CREATE TABLE `bookreview` (
  ...
  KEY `bookID` (`bookID`),
  CONSTRAINT `bookreview_ibfk_1` FOREIGN KEY (`memberID`) REFERENCES `member` (`memberID`),
  CONSTRAINT `bookreview_ibfk_2` FOREIGN KEY (`bookID`) REFERENCES `book` (`bookID`),
  CONSTRAINT `bookreview_chk_1` CHECK (((`rating` >= 0) and (`rating` <= 5)))
...
-- Dump completed on 2024-08-29 10:56:53
